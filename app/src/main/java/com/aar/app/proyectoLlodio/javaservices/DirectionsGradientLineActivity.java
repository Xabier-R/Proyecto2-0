package com.aar.app.proyectoLlodio.javaservices;
      ...
      public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(new Style.Builder().fromUri(Style.DARK)
          .withImage(ORIGIN_ICON_ID, BitmapUtils.getBitmapFromDrawable(
            getResources().getDrawable(R.drawable.actividad1)))
          .withImage(DESTINATION_ICON_ID, BitmapUtils.getBitmapFromDrawable(
            getResources().getDrawable(R.drawable.actividad2))), new Style.OnStyleLoaded() {
              @Override
                public void onStyleLoaded(@NonNull Style style) {
                  ...
                  Toast.makeText(DirectionsGradientLineActivity.this,("str"), Toast.LENGTH_SHORT).show();
              }
            });
      }
    });
